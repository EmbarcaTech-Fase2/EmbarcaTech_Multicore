...
void tela0(ssd1306_t *ssd, uint16_t r, uint16_t g, uint16_t b, char* str_red, char* str_green, char* str_blue, char* str_clear) {//Tela 0 - Sensor de cor GY33
  ...
  ssd1306_draw_string(ssd, color_name, 32, 16);  // Mostra o nome da cor
...
void tela1(ssd1306_t *ssd, uint16_t lux, char* str_lux) {//Tela 1 - Sensor de luz GY302
  ssd1306_rect(ssd, 3, 3, 122, 60, true, false);       // Desenha um retângulo
  ssd1306_line(ssd, 3, 25, 123, 25, true);            // Desenha uma linha
  ssd1306_line(ssd, 3, 37, 123, 37, true);            // Desenha uma linha
